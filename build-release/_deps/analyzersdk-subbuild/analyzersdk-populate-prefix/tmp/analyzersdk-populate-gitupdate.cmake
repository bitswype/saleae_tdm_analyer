...
execute_process(
  COMMAND "/usr/bin/git" show-ref "alpha"
  WORKING_DIRECTORY "/home/ed/Documents/saleae_tdm_analyer/build-release/_deps/analyzersdk-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("alpha" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/alpha")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ed/Documents/saleae_tdm_analyer/build-release/_deps/analyzersdk-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ed/Documents/saleae_tdm_analyer/build-release/_deps/analyzersdk-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
